 ...
 * Class User
 *
 * @method bool hasRole(string|array $roles)   Cek apakah user punya role tertentu
 * @method $this assignRole(string|array $roles)  Assign role ke user
 * @method \Illuminate\Database\Eloquent\Builder role(string|array $roles) Scope query user by role
 * @property int $id
 * @property string $name
